...
public interface TarGzFile extends FileResource {
    ...
    /// @param tarGzFileType the requested type
    /// @param path the path
    /// @return the compressed TAR file
    ///
    @SuppressWarnings("PMD.ShortMethodName")
    static <T extends InputResource> T of(ResourceType<T> tarGzFileType,
            Path path) {
        return ResourceFactory.create(tarGzFileType, path);
    }
