...
/// A provider for [execution results][ExecResult] from invoking a script.
...
///     that indicates successful execution. The date of the result is set
///     to the current date.
/// 
...
public class ScriptExecutor extends AbstractProvider
    ...
    /// the absolute path of the script (or the name of the executor, if
    /// [#script(String))]) is used) will automatically be added as first
    /// argument, i.e. before the arguments specified by this method.
    ///
