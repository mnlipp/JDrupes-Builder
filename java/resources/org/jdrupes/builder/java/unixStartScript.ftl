...
##############################################################################
#
#   [=applicationName] start up script for POSIX generated by JDrupes Builder.
#
...
#       and [=optsEnvironmentVar]) rely on word-splitting, this is performed
#       explicitly; see the in-line comments for details.
#
#       There are tweaks for specific operating systems such as AIX, CygWin,
#       Darwin, MinGW, and NonStop.
#
#   (3) This script is generated from the FreeMarker template
#       within the JDrupes Builder project (https://builder.jdrupes.org/).
#
##############################################################################
...
set -- \
<#if appNameSystemProperty??>    "-D[=appNameSystemProperty]=$APP_BASE_NAME" \
</#if><#if classpath??>    -classpath "$CLASSPATH" \
</#if><#if modulePath??>    --module-path "$MODULE_PATH" \
</#if>    [=mainClassName!entryPointArgs] \
    "$@"
